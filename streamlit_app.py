...
st.markdown(f"<p style='color:red; text-align: center; font-size: 20px;'>🔻 نسبة الفائدة: {profit_percentage:.2f}%</p>", unsafe_allow_html=True)

# عرض قيمة الفائدة
st.write(f"💰 قيمة الفائدة: {profit_value:.2f} DZD")

# عرض نسبة رأس المال باللون الأخضر مع تكبير الخط
st.markdown(f"<p style='color:green; text-align: center; font-size: 20px;'>🔺 نسبة رأس المال: {capital_percentage:.2f}%</p>", unsafe_allow_html=True)
